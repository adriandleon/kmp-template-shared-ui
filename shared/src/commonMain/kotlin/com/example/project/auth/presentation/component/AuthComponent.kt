 ...
 *
 * This interface defines the contract for authentication components in the presentation layer. It
 * provides access to the authentication state and intents for UI components.
 */
